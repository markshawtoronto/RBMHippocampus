...
alpha = 0.1; % Amount of temporal blurring. 0.1 is low temporal blurring
...
for t = 1:Ntimestep % Repeat Ntimestep times
   ...
   for j = 1:Npats
        ...
        input = gridCellLayer * (1-alpha) + prevGridCellLayer * alpha; % Blur the two together
        
        prevGridCellLayer = input; % save pattern for the next run
