...
for q = 0:9
    for t = 1:10
        subplot(3,4,(t+(10*q))) % Plot each cell individually
        plot(pos(1,1:spikeskip:length(pos)),pos(2,1:spikeskip:length(pos)),'.','MarkerSize',8);
        hold on; plot(pos(1,spikeskip*find(savedAbstract(1:spikeskip:end, t)>abstractThr)),pos(2,spikeskip*find(savedAbstract(1:spikeskip:end, t)>abstractThr)),'R.','MarkerSize',15)
